...
<head>
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="{{ asset('template01new/css/style.min.css') }}" media="all">
    ...
    <link rel="stylesheet" id="uikit-css" href="{{ asset('template01new/css/uikit.min.css') }}" media="all">
    <link rel="stylesheet" id="reset uikit-css" href="{{ asset('template01new/css/reset1.css') }}" media="all">
    <link rel="stylesheet" id="remixicon-css" href="{{ asset('template01new/css/remixicon.css') }}" media="all">
    <link rel="stylesheet" id="preload-css" href="{{ asset('template01new/css/preload.css') }}" media="all">
    <link rel="stylesheet" id="wedding reset-css" href="{{ asset('template01new/css/reset-wedding.css') }}"
        media="all">
    <link rel="stylesheet" id="fancybox-css" href="{{ asset('template01new/css/fancybox.css') }}" media="all">
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template01new/css/swiper-bundle.min.css') }}"
        media="all">
    <link rel="stylesheet" id="animation-css" href="{{ asset('template01new/css/animation.css') }}" media="all">
    <link rel="stylesheet" id="aos style-css" href="{{ asset('template01new/css/aos.css') }}" media="all">
    <link rel="stylesheet" id="footer style-css" href="{{ asset('template01new/css/footer.css') }}" media="all">
    <link rel="stylesheet" id="wedding style-css" href="{{ asset('template01new/css/wedding.css') }}" media="all">
    <link rel="stylesheet" id="theme-css" href="{{ asset('template01new/css/theme.css') }}" media="all">
    <script src="{{ asset('template01new/js/jquery.min_1.js') }}" id="jquery-core-js"></script>
    <script src="{{ asset('template01new/js/jquery-migrate.min.js') }}" id="jquery-migrate-js"></script>
    <script src="{{ asset('template01new/js/jquery.min.js') }}" id="Jquery-js"></script>
    ...
    <link rel="stylesheet" href="{{ asset('template01new/css/style.css') }}">
    <script src="{{ asset('template01new/js/wp-emoji-release.min.js') }}" defer=""></script>
</head>
...
<body
    ...
    <!-- AUDIO -->
    <audio src="{{ asset('template01new/media/Shane-Filan-Beautiful-In-White-Official-Video.mp3') }}" controls=""
        autoplay="" id="audio">
    ...
    <script src="{{ asset('template01new/js/fancybox.umd.js') }}" id="fancybox js-js"></script>
    <script src="{{ asset('template01new/js/uikit.min.js') }}" id="uikit js-js"></script>
    <script src="{{ asset('template01new/js/uikit-icons.min.js') }}" id="uikit icon-js"></script>
    <script src="{{ asset('template01new/js/preloader.js') }}" id="preloader js-js"></script>
    <script src="{{ asset('template01new/js/aos.js') }}" id="aos js-js"></script>
    <script src="{{ asset('template01new/js/swiper-bundle.min.js') }}" id="swiper slide-js"></script>
    <script src="{{ asset('template01new/js/scrollreveal.min.js') }}" id="scrollrevea-js"></script>
    <script src="{{ asset('template01new/js/main-wedding.js') }}" id="main wedding-js"></script>
    <script src="{{ asset('template01new/css/style.css') }}" id="comment-reply-js" async="" data-wp-strategy="async"></script>
