...
<head>
    ...
    <link rel="stylesheet" id="wedding reset-css" href="{{ asset('template11/css/reset-wedding.css') }}"
        media="all">
    <link rel="stylesheet" id="fancybox-css" href="{{ asset('template11/css/fancybox.css') }}" media="all">
    <link rel="stylesheet" id="swiper slide-css" href="{{ asset('template11/css/swiper-bundle.min.css') }}"
        media="all">
                ...
                <div class="uk-grid uk-child-width-1-2@m" uk-grid="">
                    ...
                    <div class="invitation-card">
                        ...
                        <div class="invitation-body" style="background: #FFFF;color:black;">
                            ...
                            <h3 class="" style="font-size: 18px;font-weight: bold;">Tại:
                                {{ $weddingCard->address_bride }}</h3>
                            <p style="font-size: 17px;font-weight: 500;"> Vào lúc <b
                                    style="font-size:20px">{{ $weddingCard->time_bride }}</b> </p>
                    ...
                    <div class="invitation-card">
                        ...
                        <div class="invitation-body" style="background: #FFFF;color:black;">
                            ...
                            <p style="font-size: 17px;font-weight: 500;"> Vào lúc <b
                                    style="font-size:20px">{{ $weddingCard->time_groom }}</b> </p>
                            <p style="font-size: 17px;">@php
                                \Carbon\Carbon::setLocale('vi'); // Đặt ngôn ngữ tiếng Việt
                            ...
                            @endphp
                                {{ $weekdayGroom }}, Ngày <b
                                    style="font-size:20px">{{ \Carbon\Carbon::parse($weddingCard->groom_eating_date)->day }}-{{ \Carbon\Carbon::parse($weddingCard->groom_eating_date)->month }}-{{ \Carbon\Carbon::parse($weddingCard->groom_eating_date)->year }}</b>
                            </p>
 ...
 <div class="uk-position-cover uk-overlay uk-overlay-primary" style="opacity:.5"> </div>
    ...
    @if ($weddingCard->message_gift != ',')
        <section id="gift" class="section-gift" style="display:block">
            <div class="container">
                <p class="subtitle"></p>
                <h2 class="script-font uk-heading-small uk-text-center uk-text-cappercase scrollrevea-js">
    ...
    <section id="thankyou" class="section-thankyou bg_overlay uk-position-z-index">
        ...
        <div class="thankyou-body container uk-position-relative uk-position-z-index">
            ...
            <span>{{ $weddingCard->message_thanks }}</span>
            <p></p>
    ...
    <!-- AUDIO -->
    <audio src="{{ asset('template11/media/Shane-Filan-Beautiful-In-White-Official-Video-3.mp3') }}" controls=""
        autoplay="" id="audio">
    ...
    <script src="{{ asset('template01/js/comment-reply.min.js') }}" id="comment-reply-js" async=""
